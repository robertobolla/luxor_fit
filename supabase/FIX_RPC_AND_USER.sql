...
-- ============================================================================
-- SCRIPT DE MANTENIMIENTO: RECARGAR SCHEMA CACHE & VERIFICAR FUNCIÓN (SOLO)
-- ============================================================================

-- 1. Intentar forzar la recarga de la caché de configuración de PostgREST
-- Esto es necesario cuando se agregan nuevas funciones RPC y no aparecen inmediatamente.
NOTIFY pgrst, 'reload config';

-- 2. Asegurarse de que la función existe (Redefinición total y limpia)
