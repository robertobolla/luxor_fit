...
-- Ejecuta solo este script (sin ON CONFLICT problemático)
-- ============================================================================
...
-- Verificación
SELECT 
  '✅ FUNCION ACTUALIZADA EXITOSAMENTE' as status,
  'Los admins ahora pueden ver estadisticas de CUALQUIER usuario' as descripcion,
  'Recarga el dashboard y haz clic en Ver Info de Lucas' as siguiente_paso;
