...
-- 3. ELIMINAR la vista existente antes de recrearla
DROP VIEW IF EXISTS public.v_user_subscription CASCADE;

-- 4. Crear la vista actualizada v_user_subscription con información de plataforma
...
-- 5. Función para sincronizar desde RevenueCat webhook
...
-- 6. Marcar suscripciones Stripe existentes
...
WHERE table_name = 'subscriptions'
  ...
  AND column_name IN ('revenuecat_customer_id', 'product_identifier', 'platform')
